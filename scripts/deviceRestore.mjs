...
console.log(await t.evaluate("JSON.stringify({ w: innerWidth, url: location.href, card: !!document.querySelector('.social-progress'), text: document.body.innerText.replace(/\s+/g,' ').slice(0,180) })"));
